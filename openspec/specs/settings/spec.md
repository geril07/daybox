...
A settings drawer with timer configuration (durations, auto-start, alarm), display settings (theme, first day of week), group management, and data export/import.
