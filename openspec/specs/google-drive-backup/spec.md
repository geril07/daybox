...
- **WHEN** a connected user confirms the backup dialog and no prior visible root backup file exists
...
- **WHEN** a connected user confirms the backup dialog and `dayboxFileId` identifies an accessible visible Drive file
